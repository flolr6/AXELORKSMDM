...
import com.axelor.apps.supplychain.service.saleorder.SaleOrderSplitSupplychainServiceImpl;
...
public class SupplychainModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(PurchaseOrderLineViewServiceSupplychain.class)
    ...
    bind(SaleOrderLineViewServiceSupplychain.class)
